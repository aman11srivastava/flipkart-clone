...
export const logoURL: string = 'https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/flipkart-plus_8d85f4.png';
export const subURL: string = 'https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/plus_aef861.png';
...
export const timerURL: string = 'https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/timer_a73398.svg';

export const adURL: string = 'https://rukminim1.flixcart.com/flap/464/708/image/633789f7def60050.jpg?q=70';
